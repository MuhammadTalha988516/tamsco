...
import cov from '../../assets/cov.webp';
import highbay from '../../assets/highbay.webp';
import flood from '../../assets/flood.webp';
...
import tennis from '../../assets/tenniscenter.webp';
import kitchen from '../../assets/modernkitchen.webp';
import livingroom from '../../assets/livingroom.webp';
import minibedroom from '../../assets/minibedroom.webp';
import staircase from '../../assets/staircase.webp';
...
export const values = [
  ...
  { title: 'Innovation', desc: 'We constantly seek better solutions and embrace bold ideas.' },
  { title: 'Collaboration', desc: 'We thrive through teamwork and the sharing of diverse perspectives.' },
  { title: 'Excellence', desc: 'We aim for outstanding results and continuous improvement.' },
];
...
export const renovationProjects = [
  ...
  },
  {
    ...
    tag: 'Exterior',
    description: 'An outdoor living space with pergola, kitchen, and weatherproof finishes.',
...
export const sportsProjects = [
  ...
  },
  {
    ...
    tag: 'Aquatics',
    description: 'A world-class aquatics center engineered for precision and safety.',
  ...
  },
  {
    ...
    tag: 'Track',
    description: 'IAAF-spec track with advanced drainage and multi-event facilities.',
  ...
  },
  {
    ...
    tag: 'Facility',
    description: 'High-performance center with gym, therapy, and analytics lab.',
