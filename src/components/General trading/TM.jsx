...
const equipment = [
  {
    title: "Oscilloscope",
    desc: "High-precision digital oscilloscopes for signal analysis.",
    points: ["Digital sampling", "Multi-channel input", "Waveform analysis", "Trigger functions"],
    animation: activity,
  },
  {
    title: "Differential Probe Oscilloscope",
    desc: "Advanced probes for differential signal measurement.",
    points: ["High bandwidth", "Common mode rejection", "Floating measurements", "Low noise design"],
    animation: alertCircle,
  },
  {
    title: "Digital Multi-meter",
    desc: "Portable digital multimeters for precise measurements.",
    points: ["High accuracy", "Auto-ranging", "Data logging", "True RMS"],
    animation: alertTriangle,
  },
  {
    title: "Bench Multi-meter",
    desc: "Laboratory-grade bench multimeters with advanced features.",
    points: ["High resolution", "System integration", "PC connectivity", "Calibration ready"],
    animation: lock,
  },
  {
    title: "Clamp Meter",
    desc: "Non-contact current measurement with clamp-on design.",
    points: ["AC current", "Jaw opening", "Safety rated", "Compact design"],
    animation: loading,
  },
  {
    title: "AC/DC Clamp Meter",
    desc: "Dual-function clamp meters for AC and DC current.",
    points: ["AC/DC measurement", "Hall effect sensor", "Wide range", "Digital display"],
    animation: settings,
  },
  {
    title: "DC Electronic Load",
    desc: "Programmable electronic loads for testing power supplies.",
    points: ["Constant current", "Constant voltage", "Constant power", "Remote control"],
    animation: activity,
  },
  {
    title: "Visual Fault Locator",
    desc: "Fiber optic fault location with visible laser technology.",
    points: ["Red laser diode", "Connector adapters", "Fiber testing", "Fault identification"],
    animation: alertCircle,
  },
];
...
export default function TM() {
  ...
  // Glassy background opacities
  const cardBg = ["bg-white/5", "bg-white/15", "bg-white/10"];

  return (
    <div className="relative mt-15 h-[100vh] flex flex-col items-center justify-center py-16 px-6">
      {/* Static full page gradient background */}
      <div
      ...
      {/* Heading */}
      <h2
        className={`text-4xl md:text-5xl font-extrabold text-white mb-3 transform transition-all duration-1000 text-center ${
      ...
      >
        Transparent glass-style cards with frosted glass effect.
      </p>
      ...
      >
        ...
        <div className="w-full flex items-center justify-center gap-8">
          {visible.map((item, i) => {
            ...
            if (i === 0) {
              style = {
                transform: "rotate(-8deg) translateX(-30px) translateZ(-40px) scale(0.96)",
