    ...
    <section className="relative bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 py-20 px-6 overflow-hidden">
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 max-w-6xl mx-auto relative z-10">
        {values.map((value, index) => (
          <div key={index} className="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 p-8 text-center border-t-4 border-indigo-500 hover:-translate-y-2 hover:bg-gradient-to-br hover:from-indigo-50 hover:to-purple-50">
