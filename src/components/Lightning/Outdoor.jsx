    ...
    <section className="py-24 bg-gradient-to-b from-blue-50 to-white text-gray-900">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-extrabold text-blue-900 mb-3">Outdoor Lighting</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 relative group overflow-hidden rounded-3xl shadow-2xl">
            <img
              src={outdoorLighting[0].image}
              alt={outdoorLighting[0].title}
            ...
            <div className="absolute inset-0 bg-blue-900/60 opacity-0 group-hover:opacity-100 transition duration-500 flex items-end p-6">
              <h3 className="text-3xl font-bold text-white">{outdoorLighting[0].title}</h3>
            </div>
          </div>

          {/* Stacked cards on right */}
          <div className="grid gap-6">
            {outdoorLighting.slice(1).map((item, i) => (
