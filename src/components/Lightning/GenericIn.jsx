    ...
    <>
      ...
      <section className="relative py-32 bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-800 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black bg-gradient-to-r from-white via-yellow-200 to-white bg-clip-text text-transparent mb-8 drop-shadow-2xl animate-pulse">
              Illuminate Your Home
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-blue-100 font-light mb-8">
              Transform spaces into masterpieces with cutting-edge indoor lighting
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/genericin"
                className="w-full sm:w-auto bg-white text-purple-600 px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-110 hover:rotate-3 shadow-lg hover:shadow-xl"
              >
                Explore Collection
              </Link>
              <Link
                to="/ContactUs"
                className="w-full sm:w-auto border-2 border-white text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-purple-600 transition-all duration-300 transform hover:scale-110"
              >
                Get Quote
              </Link>
            </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={i} className="transform hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-2">{stat.label}</h3>
                <p className="text-sm md:text-base text-gray-600">{stat.sub}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-28 bg-gradient-to-br from-white via-blue-50 to-purple-50 text-gray-900 relative">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-24">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-6">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16">
              ...
              <Link key={i} className="group">
                ...
                >
                  <img
                    src={item.image}
                    alt={item.title}
                    className="w-full h-72 md:h-80 object-cover transform group-hover:scale-110 transition-all duration-700"
                  />
      ...
      <section className="py-24 bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl sm:text-5xl font-black mb-6">Why Our Indoor Lighting Reigns Supreme</h2>
          <p className="text-base sm:text-lg md:text-xl mb-16 font-medium">Advanced features that transform your living experience</p>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-12">
            ...
            <div className="group bg-white/10 backdrop-blur-lg rounded-2xl p-8 hover:bg-white/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border border-white/20">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4">Advanced LED Technology</h3>
            ...
            <div className="group bg-white/10 backdrop-blur-lg rounded-2xl p-8 hover:bg-white/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border border-white/20">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4">Intelligent Dimming</h3>
              <p className="text-sm md:text-lg font-medium leading-relaxed">
            ...
            <div className="group bg-white/10 backdrop-blur-lg rounded-2xl p-8 hover:bg-white/20 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 border border-white/20">
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-4">Premium Materials</h3>
              <p className="text-sm md:text-lg font-medium leading-relaxed">
      ...
      <section className="py-24 bg-gradient-to-r from-purple-700 via-pink-600 to-red-600 text-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black mb-6">Ready to Transform Your Space?</h2>
          <p className="text-lg sm:text-xl md:text-2xl mb-10 opacity-90">Let's create the perfect lighting solution for your home</p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
            <Link
              to="/ContactUs"
              className="w-full sm:w-auto bg-white text-purple-700 px-10 py-4 rounded-full font-bold text-lg md:text-xl hover:bg-gray-100 transition-all duration-300 transform hover:scale-110 shadow-2xl"
            >
              Get Free Consultation
            </Link>
            <Link
              to="/lights"
              className="w-full sm:w-auto border-2 border-white text-white px-10 py-4 rounded-full font-bold text-lg md:text-xl hover:bg-white hover:text-purple-700 transition-all duration-300 transform hover:scale-110"
            >
